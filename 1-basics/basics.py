...
age # returns 29
age = 33
age # returns the new value, 33

# Also, you can reasign a variable's value with another type of data
age = 'my age is'
age # now it returns the text 'my age is'
...
age + '1' # returns '291' because you are concatenating
...
my_blockchain # but the previous operations does not modify list's item value, it gives the original values instead ([1, 2.9, 7])
